...
<body class="nk-body bg-lighter npc-default has-sidebar ">
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">Análise</h6>
                                </li><!-- .nk-menu-item -->
                                ...
                                <li class="nk-menu-heading">
                                    <h6 class="overline-title text-primary-alt">Gerenciamento</h6>
                                </li><!-- .nk-menu-heading -->
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ route('profile.index') }}" class="nk-menu-link"><span class="nk-menu-text">Permissões</span></a>
                                        </li>                                    
                                        <li class="nk-menu-item">
                                            <a href="{{ route('roles.index') }}" class="nk-menu-link"><span class="nk-menu-text">Perfil</span></a>
                                        </li>
                                        <li class="nk-menu-item">
    ...
    <!-- JavaScript -->
    <script src="https://integracao.space/admin-app/js/bundle.js?ver=3.0.5"></script>
